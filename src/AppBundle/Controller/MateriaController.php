...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('materia/materiaindex.html.twig', array(
            'materias' => $materias,
        ));
    }
    ...
    {
        $materia = new materia();
        $form = $this->createForm('AppBundle\Form\MateriaType', $materia);
        ...
        return $this->render('materia/materianew.html.twig', array(
            'materia' => $materia,
    ...
    public function showAction(Materia $materia)
    {
        ...
        return $this->render('materia/materiashow.html.twig', array(
            'materia' => $materia,
    ...
    {
        $deleteForm = $this->createDeleteForm($materia);
        $editForm = $this->createForm('AppBundle\Form\MateriaType', $materia);
        ...
        return $this->render('materia/materiaedit.html.twig', array(
            'materia' => $materia,
