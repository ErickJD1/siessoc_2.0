...
class MovimientoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('descripcionmov',TextareaType::class, array('label'=>'Descripcion'))
                ->add('monto',MoneyType::class,array('label'=>'Monto', 'invalid_message' => 'Se require un valor numérico con un máximo de %num% caracteres','invalid_message_parameters' => array('%num%' => 9)))
