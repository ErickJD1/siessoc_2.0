...
//                ->add('tiposolicasabecario', ChoiceType::class, array('label'=>'Tipo De Solicitud','choices'=>array('Becario'=>'Becario', 'Patrocinador'=>'Patrocinador'),'placeholder'=>'Seleccionar Tipo De Solicitud'))
                ->add('carrerasoliestudiarbecario', EntityType::class, array('label'=>'Carrera a estudiar', 'required' => false, 'class'=>'AppBundle:Carrera'))
                ->add('universidadsolibecario',EntityType::class, array('label'=>'Universidad', 'required' => false,'class'=>'AppBundle:Universidad'))
