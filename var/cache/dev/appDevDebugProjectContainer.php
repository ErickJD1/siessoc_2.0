...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MB4t0MztHD', 0, '6vGsNdaLq2JSQDfrkYEnxs', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9So5vqRUWP', 0, '6vGsNdaLq2JSQDfrkYEnxs', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b1xzfWVkDL', 0, '6vGsNdaLq2JSQDfrkYEnxs', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000004567136f00007fcec38795607038bd35865f2c89822e22492c77e945(
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_0000000045670c6f00007fcec38795607038bd35865f2c89822e22492c77e945(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    public function getKnpPaginatorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['knp_paginator'] = new KnpComponentPagerPaginator_000000004567130c00007fcec38795607038bd35865f2c89822e22492c77e945(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
class DoctrineORMEntityManager_000000004567136f00007fcec38795607038bd35865f2c89822e22492c77e945 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c3a81b497dfa031428417 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c3a81b497e11681400571 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c3a81b497db7278153473 = array(
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getConnection', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getConnection();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getMetadataFactory', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getMetadataFactory();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getExpressionBuilder', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getExpressionBuilder();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'beginTransaction', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->beginTransaction();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getCache', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getCache();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'transactional', array('func' => $func), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->transactional($func);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'commit', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->commit();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'rollback', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->rollback();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getClassMetadata', array('className' => $className), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getClassMetadata($className);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'createQuery', array('dql' => $dql), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->createQuery($dql);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'createNamedQuery', array('name' => $name), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->createNamedQuery($name);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'createQueryBuilder', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->createQueryBuilder();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'flush', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->flush($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'clear', array('entityName' => $entityName), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->clear($entityName);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'close', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->close();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'persist', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->persist($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'remove', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->remove($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'refresh', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->refresh($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'detach', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->detach($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'merge', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->merge($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->copy($entity, $deep);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getRepository($entityName);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'contains', array('entity' => $entity), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->contains($entity);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getEventManager', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getEventManager();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getConfiguration', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getConfiguration();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'isOpen', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->isOpen();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getUnitOfWork', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getUnitOfWork();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getProxyFactory', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getProxyFactory();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'initializeObject', array('obj' => $obj), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->initializeObject($obj);
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'getFilters', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->getFilters();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'isFiltersStateClean', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->isFiltersStateClean();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'hasFilters', array(), $this->initializer5c3a81b497e11681400571);

        return $this->valueHolder5c3a81b497dfa031428417->hasFilters();
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 = $initializer;
    }
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__get', array('name' => $name), $this->initializer5c3a81b497e11681400571);

        if (isset(self::$publicProperties5c3a81b497db7278153473[$name])) {
            return $this->valueHolder5c3a81b497dfa031428417->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c3a81b497dfa031428417;
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c3a81b497e11681400571);
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__isset', array('name' => $name), $this->initializer5c3a81b497e11681400571);
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__unset', array('name' => $name), $this->initializer5c3a81b497e11681400571);
    ...
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__clone', array(), $this->initializer5c3a81b497e11681400571);

        $this->valueHolder5c3a81b497dfa031428417 = clone $this->valueHolder5c3a81b497dfa031428417;
    }

    public function __sleep()
    {
        $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, '__sleep', array(), $this->initializer5c3a81b497e11681400571);

        return array('valueHolder5c3a81b497dfa031428417');
    }
    ...
    {
        return $this->initializer5c3a81b497e11681400571;
    }
    ...
    {
        return $this->initializer5c3a81b497e11681400571 && $this->initializer5c3a81b497e11681400571->__invoke($this->valueHolder5c3a81b497dfa031428417, $this, 'initializeProxy', array(), $this->initializer5c3a81b497e11681400571);
    }
    ...
    {
        return null !== $this->valueHolder5c3a81b497dfa031428417;
    }
    ...
    {
        return $this->valueHolder5c3a81b497dfa031428417;
    }


}

class KnpComponentPagerPaginator_000000004567130c00007fcec38795607038bd35865f2c89822e22492c77e945 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c3a81b4a305a584892086 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c3a81b4a306f975092708 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c3a81b4a301f767207680 = array(
    ...
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer5c3a81b4a306f975092708);

        return $this->valueHolder5c3a81b4a305a584892086->setDefaultPaginatorOptions($options);
    }
    ...
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer5c3a81b4a306f975092708);

        return $this->valueHolder5c3a81b4a305a584892086->paginate($target, $page, $limit, $options);
    }
    ...
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer5c3a81b4a306f975092708);

        return $this->valueHolder5c3a81b4a305a584892086->subscribe($subscriber);
    }
    ...
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer5c3a81b4a306f975092708);

        return $this->valueHolder5c3a81b4a305a584892086->connect($eventName, $listener, $priority);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer5c3a81b4a306f975092708 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__get', array('name' => $name), $this->initializer5c3a81b4a306f975092708);

        if (isset(self::$publicProperties5c3a81b4a301f767207680[$name])) {
            return $this->valueHolder5c3a81b4a305a584892086->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c3a81b4a305a584892086;
    ...
    public function __set($name, $value)
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c3a81b4a306f975092708);
    ...
    public function __isset($name)
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__isset', array('name' => $name), $this->initializer5c3a81b4a306f975092708);
    ...
    public function __unset($name)
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__unset', array('name' => $name), $this->initializer5c3a81b4a306f975092708);
    ...
    public function __clone()
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__clone', array(), $this->initializer5c3a81b4a306f975092708);

        $this->valueHolder5c3a81b4a305a584892086 = clone $this->valueHolder5c3a81b4a305a584892086;
    }

    public function __sleep()
    {
        $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, '__sleep', array(), $this->initializer5c3a81b4a306f975092708);

        return array('valueHolder5c3a81b4a305a584892086');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5c3a81b4a306f975092708;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer5c3a81b4a306f975092708 && $this->initializer5c3a81b4a306f975092708->__invoke($this->valueHolder5c3a81b4a305a584892086, $this, 'initializeProxy', array(), $this->initializer5c3a81b4a306f975092708);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5c3a81b4a305a584892086;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c3a81b4a305a584892086;
    }


}

class FOSUserBundleDoctrineUserManager_0000000045670c6f00007fcec38795607038bd35865f2c89822e22492c77e945 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c3a81b4a4e68299531228 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c3a81b4a4e7a110376585 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c3a81b4a4e39647060067 = array(
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'deleteUser', array('user' => $user), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->deleteUser($user);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'getClass', array(), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->getClass();
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUserBy($criteria);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUsers', array(), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUsers();
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'reloadUser', array('user' => $user), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->reloadUser($user);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->updateUser($user, $andFlush);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'createUser', array(), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->createUser();
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUserByEmail', array('email' => $email), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUserByEmail($email);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUserByUsername', array('username' => $username), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUserByUsername($username);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUserByUsernameOrEmail($usernameOrEmail);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->findUserByConfirmationToken($token);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->updateCanonicalFields($user);
    }
    ...
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'updatePassword', array('user' => $user), $this->initializer5c3a81b4a4e7a110376585);

        return $this->valueHolder5c3a81b4a4e68299531228->updatePassword($user);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer5c3a81b4a4e7a110376585 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__get', array('name' => $name), $this->initializer5c3a81b4a4e7a110376585);

        if (isset(self::$publicProperties5c3a81b4a4e39647060067[$name])) {
            return $this->valueHolder5c3a81b4a4e68299531228->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c3a81b4a4e68299531228;
    ...
    public function __set($name, $value)
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c3a81b4a4e7a110376585);
    ...
    public function __isset($name)
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__isset', array('name' => $name), $this->initializer5c3a81b4a4e7a110376585);
    ...
    public function __unset($name)
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__unset', array('name' => $name), $this->initializer5c3a81b4a4e7a110376585);
    ...
    public function __clone()
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__clone', array(), $this->initializer5c3a81b4a4e7a110376585);

        $this->valueHolder5c3a81b4a4e68299531228 = clone $this->valueHolder5c3a81b4a4e68299531228;
    }

    public function __sleep()
    {
        $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, '__sleep', array(), $this->initializer5c3a81b4a4e7a110376585);

        return array('valueHolder5c3a81b4a4e68299531228');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5c3a81b4a4e7a110376585;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer5c3a81b4a4e7a110376585 && $this->initializer5c3a81b4a4e7a110376585->__invoke($this->valueHolder5c3a81b4a4e68299531228, $this, 'initializeProxy', array(), $this->initializer5c3a81b4a4e7a110376585);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5c3a81b4a4e68299531228;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c3a81b4a4e68299531228;
    }
