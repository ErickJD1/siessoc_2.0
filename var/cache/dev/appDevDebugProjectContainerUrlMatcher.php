...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/expedientebecario')) {
            ...
            // expedientebecario_mi
            if ($pathinfo === '/expedientebecario/miExpediente') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_expedientebecario_mi;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ExpedientebecarioController::miExpAction',  '_route' => 'expedientebecario_mi',);
            }
            not_expedientebecario_mi:
        ...
        if (0 === strpos($pathinfo, '/in')) {
            if (0 === strpos($pathinfo, '/insumo')) {
                ...
                if (rtrim($pathinfo, '/') === '/insumo') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_insumo_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'insumo_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\InsumoController::indexAction',  '_route' => 'insumo_index',);
                }
                not_insumo_index:
                ...
                if ($pathinfo === '/insumo/new') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\InsumoController::newAction',  '_route' => 'insumo_new',);
                }
                not_insumo_new:

                // insumo_show
                if (preg_match('#^/insumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_insumo_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'insumo_show')), array (  '_controller' => 'AppBundle\\Controller\\InsumoController::showAction',));
                }
                not_insumo_show:
                ...
                if (preg_match('#^/insumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_insumo_show_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'insumo_show_delete')), array (  '_controller' => 'AppBundle\\Controller\\InsumoController::showDeleteAction',));
                }
                not_insumo_show_delete:

                // insumo_edit
                if (preg_match('#^/insumo/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_insumo_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'insumo_edit')), array (  '_controller' => 'AppBundle\\Controller\\InsumoController::editAction',));
                }
                not_insumo_edit:
                ...
                if (preg_match('#^/insumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'insumo_delete')), array (  '_controller' => 'AppBundle\\Controller\\InsumoController::deleteAction',));
                }
                not_insumo_delete:
            ...
            if (0 === strpos($pathinfo, '/inventario')) {
                // inventario_index
                if (rtrim($pathinfo, '/') === '/inventario') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_inventario_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'inventario_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\InventarioController::indexAction',  '_route' => 'inventario_index',);
                }
                not_inventario_index:

                // inventario_new
                if ($pathinfo === '/inventario/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_inventario_new;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\InventarioController::newAction',  '_route' => 'inventario_new',);
                }
                not_inventario_new:

                // inventario_show
                if (preg_match('#^/inventario/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_inventario_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'inventario_show')), array (  '_controller' => 'AppBundle\\Controller\\InventarioController::showAction',));
                }
                not_inventario_show:

                // inventario_show_delete
                if (preg_match('#^/inventario/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_inventario_show_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'inventario_show_delete')), array (  '_controller' => 'AppBundle\\Controller\\InventarioController::showDeleteAction',));
                }
                not_inventario_show_delete:

                // inventario_edit
                if (preg_match('#^/inventario/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_inventario_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'inventario_edit')), array (  '_controller' => 'AppBundle\\Controller\\InventarioController::editAction',));
                }
                not_inventario_edit:
                ...
                if (preg_match('#^/inventario/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_inventario_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'inventario_delete')), array (  '_controller' => 'AppBundle\\Controller\\InventarioController::deleteAction',));
                }
                not_inventario_delete:
        ...
        if (0 === strpos($pathinfo, '/t')) {
            if (0 === strpos($pathinfo, '/tipo')) {
                ...
                if (0 === strpos($pathinfo, '/tipoinsumo')) {
                    // tipoinsumo_index
                    if (rtrim($pathinfo, '/') === '/tipoinsumo') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_tipoinsumo_index;
                        }

                        if (substr($pathinfo, -1) !== '/') {
                            return $this->redirect($pathinfo.'/', 'tipoinsumo_index');
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::indexAction',  '_route' => 'tipoinsumo_index',);
                    }
                    not_tipoinsumo_index:

                    // tipoinsumo_new
                    if ($pathinfo === '/tipoinsumo/new') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_tipoinsumo_new;
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::newAction',  '_route' => 'tipoinsumo_new',);
                    }
                    not_tipoinsumo_new:

                    // tipoinsumo_show
                    if (preg_match('#^/tipoinsumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_tipoinsumo_show;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'tipoinsumo_show')), array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::showAction',));
                    }
                    not_tipoinsumo_show:

                    // tipoinsumo_show_delete
                    if (preg_match('#^/tipoinsumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_tipoinsumo_show_delete;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'tipoinsumo_show_delete')), array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::showDeleteAction',));
                    }
                    not_tipoinsumo_show_delete:

                    // tipoinsumo_edit
                    if (preg_match('#^/tipoinsumo/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_tipoinsumo_edit;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'tipoinsumo_edit')), array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::editAction',));
                    }
                    not_tipoinsumo_edit:
                    ...
                    if (preg_match('#^/tipoinsumo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if ($this->context->getMethod() != 'DELETE') {
                            $allow[] = 'DELETE';
                            goto not_tipoinsumo_delete;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'tipoinsumo_delete')), array (  '_controller' => 'AppBundle\\Controller\\TipoinsumoController::deleteAction',));
                    }
                    not_tipoinsumo_delete:
