    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Colaboracionmonetaria')) {
            ...
            if (rtrim($pathinfo, '/') === '/Colaboracionmonetaria') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\ColaboracionmonetariaController::showAllPostAction',  '_route' => 'Colaboracionmonetaria_index',);
            }

            // Colaboracionmonetaria_new
            if ($pathinfo === '/Colaboracionmonetaria/create') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_Colaboracionmonetaria_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ColaboracionmonetariaController::createColaboracionAction',  '_route' => 'Colaboracionmonetaria_new',);
            }
            ...
            if (preg_match('#^/Colaboracionmonetaria/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Colaboracionmonetaria_show')), array (  '_controller' => 'AppBundle\\Controller\\ColaboracionmonetariaController::showColaboracionAction',));
            }
            not_Colaboracionmonetaria_show:

            // Colaboracionmonetaria_edit
            if (0 === strpos($pathinfo, '/Colaboracionmonetaria/edit') && preg_match('#^/Colaboracionmonetaria/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_Colaboracionmonetaria_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Colaboracionmonetaria_edit')), array (  '_controller' => 'AppBundle\\Controller\\ColaboracionmonetariaController::editColaboracionAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/movimiento')) {
            ...
            // movimiento_edit
            if (preg_match('#^/movimiento/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        if (0 === strpos($pathinfo, '/tipo')) {
            ...
            if (0 === strpos($pathinfo, '/tipomovimiento')) {
                ...
                // tipomovimiento_edit
                if (preg_match('#^/tipomovimiento/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        if ($pathinfo === '/calendar') {
            ...
            return array (  '_controller' => 'AppBundle\\Controller\\WebSiteController::calendarAction',  '_route' => 'web_history',);
        }
        not_web_history:
