...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/expedientebecario')) {
            ...
            // miexpedientebecario_show
            if ($pathinfo === '/expedientebecario/miexpediente') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_miexpedientebecario_show;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ExpedientebecarioController::miExpAction',  '_route' => 'miexpedientebecario_show',);
            }
            not_miexpedientebecario_show:
