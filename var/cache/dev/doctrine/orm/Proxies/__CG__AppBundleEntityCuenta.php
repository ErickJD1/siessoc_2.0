...
class Cuenta extends \AppBundle\Entity\Cuenta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'idcuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'numcuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'nomcuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'descripcioncuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'fechaapertura', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'saldocuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'estadocuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'idtipocuenta', '' . "\0" . 'AppBundle\\Entity\\Cuenta' . "\0" . 'idbanco'];
        }
