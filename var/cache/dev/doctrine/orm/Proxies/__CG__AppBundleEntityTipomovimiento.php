...
class Tipomovimiento extends \AppBundle\Entity\Tipomovimiento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tipomovimiento' . "\0" . 'idtipomov', '' . "\0" . 'AppBundle\\Entity\\Tipomovimiento' . "\0" . 'nombretipo', '' . "\0" . 'AppBundle\\Entity\\Tipomovimiento' . "\0" . 'descripciontipomov', '' . "\0" . 'AppBundle\\Entity\\Tipomovimiento' . "\0" . 'estadotipomov'];
        }
