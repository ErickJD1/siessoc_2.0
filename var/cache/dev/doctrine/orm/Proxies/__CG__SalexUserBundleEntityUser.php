...
namespace Proxies\__CG__\SalexUserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \SalexUserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'description', 'firstName', 'lastName', '' . "\0" . 'SalexUserBundle\\Entity\\User' . "\0" . 'profile_picture_file', '' . "\0" . 'SalexUserBundle\\Entity\\User' . "\0" . 'profilePicture', '' . "\0" . 'SalexUserBundle\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'SalexUserBundle\\Entity\\User' . "\0" . 'updateAt', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProfilePictureFile(\Symfony\Component\HttpFoundation\File\File $profile_picture_file)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProfilePictureFile', [$profile_picture_file]);

        return parent::setProfilePictureFile($profile_picture_file);
    }
    ...
    public function getLastLogin($human_readable = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastLogin', [$human_readable]);

        return parent::getLastLogin($human_readable);
    }
    ...
    public function claveAleatoria($longitud = 6, $opcLetra = true, $opcNumero = true, $opcMayus = true, $opcEspecial = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'claveAleatoria', [$longitud, $opcLetra, $opcNumero, $opcMayus, $opcEspecial]);

        return parent::claveAleatoria($longitud, $opcLetra, $opcNumero, $opcMayus, $opcEspecial);
    }
