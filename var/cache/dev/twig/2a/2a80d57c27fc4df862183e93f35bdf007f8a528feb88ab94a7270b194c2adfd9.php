...
class __TwigTemplate_f4040867adcb923b23405d6b4ac0b9536d164c5e39af1ca98dd2ce22df0cba5e extends Twig_Template
{
    ...
    {
        $__internal_643320e8f5e7a5c3ba2fa840e3e14cfe5a8f0711b3f9990918b8fc852a6cbf6a = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_643320e8f5e7a5c3ba2fa840e3e14cfe5a8f0711b3f9990918b8fc852a6cbf6a->enter($__internal_643320e8f5e7a5c3ba2fa840e3e14cfe5a8f0711b3f9990918b8fc852a6cbf6a_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "cuenta/Cuentashow.html.twig"));
    ...
    <div style=\"width:70%; margin-left: 15%\" class=\"modal-dialog\">
        ...
        echo "</strong></p>
                        ...
                        <p class=\"form-group\"><strong>";
        // line 24
        echo twig_escape_filter($this->env, ("\$" . $this->getAttribute((isset($context["cuenta"]) ? $context["cuenta"] : $this->getContext($context, "cuenta")), "saldoactual", array())), "html", null, true);
        echo "</strong></p>
                        <hr>
...
";
        ...
        $__internal_643320e8f5e7a5c3ba2fa840e3e14cfe5a8f0711b3f9990918b8fc852a6cbf6a->leave($__internal_643320e8f5e7a5c3ba2fa840e3e14cfe5a8f0711b3f9990918b8fc852a6cbf6a_prof);
    ...
    {
        return array (  89 => 37,  78 => 33,  72 => 30,  66 => 27,  60 => 24,  54 => 21,  48 => 18,  33 => 8,  22 => 1,);
    }
    ...
    <div style=\"width:70%; margin-left: 15%\" class=\"modal-dialog\">
        <div class=\"modal-content\" style=\"border-radius: 40px\">
            ...
            <div class=\"modal-header\">
                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>
                <div class=\"row\">\t
                    <h3 class=\"col col-md-11 col-md-offset-0\" align=\"center\"><strong>N° Cuenta: <strong>{{  cuenta.numcuenta }}<strong>  -   {{  cuenta.nomcuenta }}</strong></strong></strong></h3>
                </div>
            </div>
            <div class=\"modal-body\">
                ...
                <div class=\"row\" style=\"margin-left:5%\" align=\"left\">
                    ...
                    <div class=\"col col-md-7\">
                        ...
                        <hr>
                        <h4><i class=\"fa fa-money\"></i>  Saldo Actual</h4>
                        <p class=\"form-group\"><strong>{{ \"\$\"~cuenta.saldoactual }}</strong></p>
                        <hr>
                        <h4><i class=\"fa fa-home\"></i>  Banco</h4>
                        ...
                        <hr>
                        <h4><i class=\"fa fa-check-square\"></i>  Estado</h4>
                        <p class=\"form-group\"><strong>{% if cuenta.estadocuenta==1  %} Activo {% else %} Inactivo {% endif %}</strong></p>
                    </div>
                    <div class=\"col col-md-5\">
