...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BwEQ0eDeNQ', 0, '10oafQWaUJ-ky7+jWo-JIL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2ZSO1f0wkM', 0, '10oafQWaUJ-ky7+jWo-JIL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('document_file', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('profile_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('document_file', $c, $a, $b));
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('document_file', $c, $a, $b));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000072a0a62700007f9c9bffe26fdf5c751be910c07ca5f444715846bb64(
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_0000000072a0b9ba00007f9c9bffe26fdf5c751be910c07ca5f444715846bb64(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    public function getKnpPaginatorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['knp_paginator'] = new KnpComponentPagerPaginator_0000000072a0b94b00007f9c9bffe26fdf5c751be910c07ca5f444715846bb64(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(), 1 => $this->get('fos_user.user_provider.username')), 'main', $a, $c, $d), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $q, 'main', $s, $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5c6b99ebc1d284.63701594', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $q, '/login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B+Mjj85aLL', 0, '10oafQWaUJ-ky7+jWo-JIL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
...
class DoctrineORMEntityManager_0000000072a0a62700007f9c9bffe26fdf5c751be910c07ca5f444715846bb64 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5c6b99ec89440321734482 = null;
    private $initializer5c6b99ec89459040584037 = null;
    private static $publicProperties5c6b99ec893f0043812641 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getConnection', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getMetadataFactory', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getExpressionBuilder', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'beginTransaction', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getCache', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'transactional', array('func' => $func), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->transactional($func);
    }
    public function commit()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'commit', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->commit();
    }
    public function rollback()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'rollback', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getClassMetadata', array('className' => $className), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'createQuery', array('dql' => $dql), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'createNamedQuery', array('name' => $name), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'createQueryBuilder', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'flush', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'clear', array('entityName' => $entityName), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->clear($entityName);
    }
    public function close()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'close', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->close();
    }
    public function persist($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'persist', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'remove', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'refresh', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'detach', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'merge', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'contains', array('entity' => $entity), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getEventManager', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getConfiguration', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'isOpen', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getUnitOfWork', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getProxyFactory', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'initializeObject', array('obj' => $obj), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'getFilters', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'isFiltersStateClean', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'hasFilters', array(), $this->initializer5c6b99ec89459040584037);
        return $this->valueHolder5c6b99ec89440321734482->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer5c6b99ec89459040584037 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__get', array('name' => $name), $this->initializer5c6b99ec89459040584037);
        if (isset(self::$publicProperties5c6b99ec893f0043812641[$name])) {
            return $this->valueHolder5c6b99ec89440321734482->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec89440321734482;
    ...
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c6b99ec89459040584037);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec89440321734482;
    ...
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__isset', array('name' => $name), $this->initializer5c6b99ec89459040584037);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec89440321734482;
    ...
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__unset', array('name' => $name), $this->initializer5c6b99ec89459040584037);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec89440321734482;
    ...
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__clone', array(), $this->initializer5c6b99ec89459040584037);
        $this->valueHolder5c6b99ec89440321734482 = clone $this->valueHolder5c6b99ec89440321734482;
    }
    public function __sleep()
    {
        $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, '__sleep', array(), $this->initializer5c6b99ec89459040584037);
        return array('valueHolder5c6b99ec89440321734482');
    }
    ...
    {
        return $this->initializer5c6b99ec89459040584037;
    }
    public function initializeProxy()
    {
        return $this->initializer5c6b99ec89459040584037 && $this->initializer5c6b99ec89459040584037->__invoke($this->valueHolder5c6b99ec89440321734482, $this, 'initializeProxy', array(), $this->initializer5c6b99ec89459040584037);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5c6b99ec89440321734482;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c6b99ec89440321734482;
    }
}

class KnpComponentPagerPaginator_0000000072a0b94b00007f9c9bffe26fdf5c751be910c07ca5f444715846bb64 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5c6b99ec9c2ba854789784 = null;
    private $initializer5c6b99ec9c2dc138490143 = null;
    private static $publicProperties5c6b99ec9c248735191878 = array(
        
    );
    public function setDefaultPaginatorOptions(array $options)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer5c6b99ec9c2dc138490143);
        return $this->valueHolder5c6b99ec9c2ba854789784->setDefaultPaginatorOptions($options);
    }
    public function paginate($target, $page = 1, $limit = 10, array $options = array())
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer5c6b99ec9c2dc138490143);
        return $this->valueHolder5c6b99ec9c2ba854789784->paginate($target, $page, $limit, $options);
    }
    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer5c6b99ec9c2dc138490143);
        return $this->valueHolder5c6b99ec9c2ba854789784->subscribe($subscriber);
    }
    public function connect($eventName, $listener, $priority = 0)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer5c6b99ec9c2dc138490143);
        return $this->valueHolder5c6b99ec9c2ba854789784->connect($eventName, $listener, $priority);
    }
    public function __construct($initializer)
    {
        $this->initializer5c6b99ec9c2dc138490143 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__get', array('name' => $name), $this->initializer5c6b99ec9c2dc138490143);
        if (isset(self::$publicProperties5c6b99ec9c248735191878[$name])) {
            return $this->valueHolder5c6b99ec9c2ba854789784->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec9c2ba854789784;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c6b99ec9c2dc138490143);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec9c2ba854789784;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__isset', array('name' => $name), $this->initializer5c6b99ec9c2dc138490143);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec9c2ba854789784;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__unset', array('name' => $name), $this->initializer5c6b99ec9c2dc138490143);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99ec9c2ba854789784;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__clone', array(), $this->initializer5c6b99ec9c2dc138490143);
        $this->valueHolder5c6b99ec9c2ba854789784 = clone $this->valueHolder5c6b99ec9c2ba854789784;
    }
    public function __sleep()
    {
        $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, '__sleep', array(), $this->initializer5c6b99ec9c2dc138490143);
        return array('valueHolder5c6b99ec9c2ba854789784');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5c6b99ec9c2dc138490143;
    }
    public function initializeProxy()
    {
        return $this->initializer5c6b99ec9c2dc138490143 && $this->initializer5c6b99ec9c2dc138490143->__invoke($this->valueHolder5c6b99ec9c2ba854789784, $this, 'initializeProxy', array(), $this->initializer5c6b99ec9c2dc138490143);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5c6b99ec9c2ba854789784;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c6b99ec9c2ba854789784;
    }
}

class FOSUserBundleDoctrineUserManager_0000000072a0b9ba00007f9c9bffe26fdf5c751be910c07ca5f444715846bb64 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5c6b99eca04b2874828442 = null;
    private $initializer5c6b99eca04d2232529829 = null;
    private static $publicProperties5c6b99eca045a502875287 = array(
        
    );
    public function deleteUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'deleteUser', array('user' => $user), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->deleteUser($user);
    }
    public function getClass()
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'getClass', array(), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->getClass();
    }
    public function findUserBy(array $criteria)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUserBy($criteria);
    }
    public function findUsers()
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUsers', array(), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUsers();
    }
    public function reloadUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'reloadUser', array('user' => $user), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->reloadUser($user);
    }
    public function updateUser(\FOS\UserBundle\Model\UserInterface $user, $andFlush = true)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->updateUser($user, $andFlush);
    }
    public function createUser()
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'createUser', array(), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->createUser();
    }
    public function findUserByEmail($email)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUserByEmail', array('email' => $email), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUserByEmail($email);
    }
    public function findUserByUsername($username)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUserByUsername', array('username' => $username), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUserByUsername($username);
    }
    public function findUserByUsernameOrEmail($usernameOrEmail)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUserByUsernameOrEmail($usernameOrEmail);
    }
    public function findUserByConfirmationToken($token)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->findUserByConfirmationToken($token);
    }
    public function updateCanonicalFields(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->updateCanonicalFields($user);
    }
    public function updatePassword(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'updatePassword', array('user' => $user), $this->initializer5c6b99eca04d2232529829);
        return $this->valueHolder5c6b99eca04b2874828442->updatePassword($user);
    }
    public function __construct($initializer)
    {
        $this->initializer5c6b99eca04d2232529829 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__get', array('name' => $name), $this->initializer5c6b99eca04d2232529829);
        if (isset(self::$publicProperties5c6b99eca045a502875287[$name])) {
            return $this->valueHolder5c6b99eca04b2874828442->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99eca04b2874828442;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c6b99eca04d2232529829);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99eca04b2874828442;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__isset', array('name' => $name), $this->initializer5c6b99eca04d2232529829);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99eca04b2874828442;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__unset', array('name' => $name), $this->initializer5c6b99eca04d2232529829);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c6b99eca04b2874828442;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__clone', array(), $this->initializer5c6b99eca04d2232529829);
        $this->valueHolder5c6b99eca04b2874828442 = clone $this->valueHolder5c6b99eca04b2874828442;
    }
    public function __sleep()
    {
        $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, '__sleep', array(), $this->initializer5c6b99eca04d2232529829);
        return array('valueHolder5c6b99eca04b2874828442');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5c6b99eca04d2232529829;
    }
    public function initializeProxy()
    {
        return $this->initializer5c6b99eca04d2232529829 && $this->initializer5c6b99eca04d2232529829->__invoke($this->valueHolder5c6b99eca04b2874828442, $this, 'initializeProxy', array(), $this->initializer5c6b99eca04d2232529829);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5c6b99eca04b2874828442;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5c6b99eca04b2874828442;
    }
}
