...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BwEQ0eDeNQ', 0, 'pZd3WR5owsl3zrRkf5JHsk', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2ZSO1f0wkM', 0, 'pZd3WR5owsl3zrRkf5JHsk', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_00000000416adbfa00007f32c6905c55df5c751be910c07ca5f444715846bb64(
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_00000000416ac45000007f32c6905c55df5c751be910c07ca5f444715846bb64(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    public function getKnpPaginatorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['knp_paginator'] = new KnpComponentPagerPaginator_00000000416ac5d100007f32c6905c55df5c751be910c07ca5f444715846bb64(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m->add($i, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_BECARIO', 2 => 'ROLE_PATROCINADOR'), NULL);
        ...
        $p->setOptions(array('default_target_path' => 'homepage', 'always_use_default_target_path' => true, 'use_referer' => true, 'login_path' => '/login', 'target_path_parameter' => '_target_path'));
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B+Mjj85aLL', 0, 'pZd3WR5owsl3zrRkf5JHsk', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
...
class DoctrineORMEntityManager_00000000416adbfa00007f32c6905c55df5c751be910c07ca5f444715846bb64 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5bf6670c02ba3990426815 = null;
    private $initializer5bf6670c02bc4880081989 = null;
    private static $publicProperties5bf6670c02b42047286968 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getConnection', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getMetadataFactory', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getExpressionBuilder', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'beginTransaction', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getCache', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'transactional', array('func' => $func), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->transactional($func);
    }
    public function commit()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'commit', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->commit();
    }
    public function rollback()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'rollback', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getClassMetadata', array('className' => $className), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'createQuery', array('dql' => $dql), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'createNamedQuery', array('name' => $name), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'createQueryBuilder', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'flush', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'clear', array('entityName' => $entityName), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->clear($entityName);
    }
    public function close()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'close', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->close();
    }
    public function persist($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'persist', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'remove', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'refresh', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'detach', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'merge', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'contains', array('entity' => $entity), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getEventManager', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getConfiguration', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'isOpen', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getUnitOfWork', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getProxyFactory', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'initializeObject', array('obj' => $obj), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'getFilters', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'isFiltersStateClean', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'hasFilters', array(), $this->initializer5bf6670c02bc4880081989);
        return $this->valueHolder5bf6670c02ba3990426815->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer5bf6670c02bc4880081989 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__get', array('name' => $name), $this->initializer5bf6670c02bc4880081989);
        if (isset(self::$publicProperties5bf6670c02b42047286968[$name])) {
            return $this->valueHolder5bf6670c02ba3990426815->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c02ba3990426815;
    ...
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bf6670c02bc4880081989);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c02ba3990426815;
    ...
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__isset', array('name' => $name), $this->initializer5bf6670c02bc4880081989);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c02ba3990426815;
    ...
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__unset', array('name' => $name), $this->initializer5bf6670c02bc4880081989);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c02ba3990426815;
    ...
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__clone', array(), $this->initializer5bf6670c02bc4880081989);
        $this->valueHolder5bf6670c02ba3990426815 = clone $this->valueHolder5bf6670c02ba3990426815;
    }
    public function __sleep()
    {
        $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, '__sleep', array(), $this->initializer5bf6670c02bc4880081989);
        return array('valueHolder5bf6670c02ba3990426815');
    }
    ...
    {
        return $this->initializer5bf6670c02bc4880081989;
    }
    public function initializeProxy()
    {
        return $this->initializer5bf6670c02bc4880081989 && $this->initializer5bf6670c02bc4880081989->__invoke($this->valueHolder5bf6670c02ba3990426815, $this, 'initializeProxy', array(), $this->initializer5bf6670c02bc4880081989);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5bf6670c02ba3990426815;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5bf6670c02ba3990426815;
    }
}

class KnpComponentPagerPaginator_00000000416ac5d100007f32c6905c55df5c751be910c07ca5f444715846bb64 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5bf6670c226ce786571140 = null;
    private $initializer5bf6670c226e9607772557 = null;
    private static $publicProperties5bf6670c2268e600661995 = array(
        
    );
    public function setDefaultPaginatorOptions(array $options)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer5bf6670c226e9607772557);
        return $this->valueHolder5bf6670c226ce786571140->setDefaultPaginatorOptions($options);
    }
    public function paginate($target, $page = 1, $limit = 10, array $options = array())
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer5bf6670c226e9607772557);
        return $this->valueHolder5bf6670c226ce786571140->paginate($target, $page, $limit, $options);
    }
    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer5bf6670c226e9607772557);
        return $this->valueHolder5bf6670c226ce786571140->subscribe($subscriber);
    }
    public function connect($eventName, $listener, $priority = 0)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer5bf6670c226e9607772557);
        return $this->valueHolder5bf6670c226ce786571140->connect($eventName, $listener, $priority);
    }
    public function __construct($initializer)
    {
        $this->initializer5bf6670c226e9607772557 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__get', array('name' => $name), $this->initializer5bf6670c226e9607772557);
        if (isset(self::$publicProperties5bf6670c2268e600661995[$name])) {
            return $this->valueHolder5bf6670c226ce786571140->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c226ce786571140;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bf6670c226e9607772557);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c226ce786571140;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__isset', array('name' => $name), $this->initializer5bf6670c226e9607772557);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c226ce786571140;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__unset', array('name' => $name), $this->initializer5bf6670c226e9607772557);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c226ce786571140;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__clone', array(), $this->initializer5bf6670c226e9607772557);
        $this->valueHolder5bf6670c226ce786571140 = clone $this->valueHolder5bf6670c226ce786571140;
    }
    public function __sleep()
    {
        $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, '__sleep', array(), $this->initializer5bf6670c226e9607772557);
        return array('valueHolder5bf6670c226ce786571140');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5bf6670c226e9607772557;
    }
    public function initializeProxy()
    {
        return $this->initializer5bf6670c226e9607772557 && $this->initializer5bf6670c226e9607772557->__invoke($this->valueHolder5bf6670c226ce786571140, $this, 'initializeProxy', array(), $this->initializer5bf6670c226e9607772557);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5bf6670c226ce786571140;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5bf6670c226ce786571140;
    }
}

class FOSUserBundleDoctrineUserManager_00000000416ac45000007f32c6905c55df5c751be910c07ca5f444715846bb64 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5bf6670c25320755436987 = null;
    private $initializer5bf6670c25333367978513 = null;
    private static $publicProperties5bf6670c252e6727880942 = array(
        
    );
    public function deleteUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'deleteUser', array('user' => $user), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->deleteUser($user);
    }
    public function getClass()
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'getClass', array(), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->getClass();
    }
    public function findUserBy(array $criteria)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUserBy($criteria);
    }
    public function findUsers()
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUsers', array(), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUsers();
    }
    public function reloadUser(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'reloadUser', array('user' => $user), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->reloadUser($user);
    }
    public function updateUser(\FOS\UserBundle\Model\UserInterface $user, $andFlush = true)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->updateUser($user, $andFlush);
    }
    public function createUser()
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'createUser', array(), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->createUser();
    }
    public function findUserByEmail($email)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUserByEmail', array('email' => $email), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUserByEmail($email);
    }
    public function findUserByUsername($username)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUserByUsername', array('username' => $username), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUserByUsername($username);
    }
    public function findUserByUsernameOrEmail($usernameOrEmail)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUserByUsernameOrEmail($usernameOrEmail);
    }
    public function findUserByConfirmationToken($token)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->findUserByConfirmationToken($token);
    }
    public function updateCanonicalFields(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->updateCanonicalFields($user);
    }
    public function updatePassword(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'updatePassword', array('user' => $user), $this->initializer5bf6670c25333367978513);
        return $this->valueHolder5bf6670c25320755436987->updatePassword($user);
    }
    public function __construct($initializer)
    {
        $this->initializer5bf6670c25333367978513 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__get', array('name' => $name), $this->initializer5bf6670c25333367978513);
        if (isset(self::$publicProperties5bf6670c252e6727880942[$name])) {
            return $this->valueHolder5bf6670c25320755436987->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c25320755436987;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bf6670c25333367978513);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c25320755436987;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__isset', array('name' => $name), $this->initializer5bf6670c25333367978513);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c25320755436987;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__unset', array('name' => $name), $this->initializer5bf6670c25333367978513);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf6670c25320755436987;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__clone', array(), $this->initializer5bf6670c25333367978513);
        $this->valueHolder5bf6670c25320755436987 = clone $this->valueHolder5bf6670c25320755436987;
    }
    public function __sleep()
    {
        $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, '__sleep', array(), $this->initializer5bf6670c25333367978513);
        return array('valueHolder5bf6670c25320755436987');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5bf6670c25333367978513;
    }
    public function initializeProxy()
    {
        return $this->initializer5bf6670c25333367978513 && $this->initializer5bf6670c25333367978513->__invoke($this->valueHolder5bf6670c25320755436987, $this, 'initializeProxy', array(), $this->initializer5bf6670c25333367978513);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5bf6670c25320755436987;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5bf6670c25320755436987;
    }
}
